...
class _ParsedTextState extends State<ParsedText> {
  late final RegexOptions regexOptions;
  TextStyle? style;
  ...
  @override
  initState() {
    regexOptions = widget.regexOptions;
    style = widget.style;
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    Widget result = LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        if(textPainter.didExceedMaxLines && !widget.showFull){
          newString = _readMore ? widget.text.substring(0, endIndex) : widget.text;
        } else{
        ...
        if(textPainter.didExceedMaxLines && !widget.showFull && _readMore){
          log('TUT');
          ...
          text: TextSpan(
            ...
            recognizer: TapGestureRecognizer()
              ..onTap = () {
                ...
                Get.to(() => ProfileScreenProvider(nickname: widget.nickName), transition: Transition.cupertino)
                    ?.then((value) {
